    ...
    <div class="row m-0 mb-4 mt-1 new__sec">
        <div class="col-12">
          <div class="sub__header">
            <h5 class="m-0 text-dark starte__txt">{{ $header }}</h5>
                                ...
                                <div class="New___sub_tabs card-header-column-main">
                                    <div class="card__column">
                                        <select class="form-control" name="type">
                                            ...
                                            <option value="wallet_address">Wallet Address
                                            </option>
                                            <option value="sponser_id">Sponser ID
                                            </option>
                                            <option value="area_code">Team Code
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="card__column">
                                    <input type="date" name="start_date" class="form-control" value="" placeholder="Start Date" />
                                    </div>

                                    <div class="card__column">
                                    <input type="date" name="end_date" class="form-control" value="" placeholder="End Date" />
                                    </div>
